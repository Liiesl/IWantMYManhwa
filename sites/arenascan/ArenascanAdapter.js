...
class ArenascanAdapter extends ArenascanContentAdapter {
    ...
    async downloadChapter(chapterData, seriesTitle, updateStatus, options = {}) {
        ...
        const chapterLogPrefix = `[Arenascan Download Ch${index + 1}]`;
                ...
                for (const selector of selectorList) {
                    ...
                    if (images.length > 0) {
                        ...
                        for (const img of images) {
                            ...
                            if (url && url.startsWith('http') && url.includes('cdn.arenascan.com')) {
                                urls.push(url.trim());
                            }
                        }
...
if (typeof window !== 'undefined') window.ArenascanAdapter = ArenascanAdapter;
if (typeof globalThis !== 'undefined') globalThis.ArenascanAdapter = ArenascanAdapter;
if (typeof self !== 'undefined') self.ArenascanAdapter = ArenascanAdapter;
